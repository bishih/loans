...
class LoanDataResponseSchema(Schema):
    data = fields.Nested(LoanDataSchema, many=False)
...
# api.add_resource(AwesomeAPI2, '/awesome2/<id>/account/<account_id>')
docs.register(LoansEP)
# docs.register(AwesomeAPI2)
